        ...
        <div class="col-xs-12">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ trans('Poblacions::poblacions/admin_lang.listado') }}</h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="pull-right">
                        @if(Auth::user()->can("admin-poblacions-create"))
                            <a href="{{ url('admin/poblacions/create') }}" class="btn btn-success pull-right">
                                <i class="fa fa-plus-circle" aria-hidden="true"></i> {{ trans('Poblacions::poblacions/admin_lang.nueva') }}
                            </a>
                        @endif
                    </div>
                </div>
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="table_poblacions" class="table table-bordered table-striped" aria-hidden="true">
                        <thead>
                        <tr>
                            <th scope="col">
                            <th scope="col">
...
<th scope="col">
    ...
    <div class="col-xs-12">
        <div class="box ">
            <div class="box-header"><h3 class="box-title">{{ trans("Poblacions::poblacions/admin_lang.export") }}</h3></div>
            <div class="box-body">
                <a href="{{ url('admin/poblacions/export') }}" class="btn btn-app">
                    <i class="fa fa-file-excel-o" aria-hidden="true"></i>
                    {{ trans('Poblacions::poblacions/admin_lang.exportar_datos') }}
                </a>
            </div>
        </div>
    </div>
...
@section("foot_page")
    ...
    <script type="text/javascript">
        ...
        $(function () {
            oTable = $('#table_poblacions').DataTable({
                "stateSave": true,
                "stateDuration": 60,
                "processing": true,
                "responsive": true,
                ...
                columns: [
                    ...
                    {
                        "title"         : "{!! trans('Poblacions::poblacions/admin_lang.fields.active') !!}",
                        orderable       : false,
                        searchable      : false,
                        data            : 'active',
                        sWidth          : '50px'
                        ...
                        {
                                "title"         : "{!! trans('Poblacions::poblacions/admin_lang.fields.name') !!}",
                                orderable       : true,
                                searchable      : true,
                                data            : 'name',
                                name            : 'c.name',
                        ...
                        ,
                        {
                                "title"         : "{!! trans('Poblacions::poblacions/admin_lang.fields.code') !!}",
                                orderable       : true,
                                searchable      : true,
                                data            : 'code',
                                name            : 'c.code',
                        ...
                        ,
                    {
                        "title"         : "{!! trans('Poblacions::poblacions/admin_lang.acciones') !!}",
                        orderable       : false,
                        searchable      : false,
                        sWidth          : '110px',
                        data            : 'actions'
            ...
            $('tfoot th',$('#table_poblacions')).each( function (colIdx) {
                var title = $('tfoot th',$('#table_poblacions')).eq( $(this).index() ).text();
            ...
            $('#table_poblacions').on( 'keyup change','tfoot input', function (e) {
                oTable
    ...
    $.ajax({
        ...
        $('#table_poblacions tbody').on('change', 'input[type="checkbox"]', function(){
        ...
        function deleteSelected() {
            ...
            if(ids.length>0){
                deleteElements('{{ url('admin/poblacions/delete-selected') }}', ids);
            }
        }

        function getSelectedRecords() {
            var ids = [];
            $('#table_poblacions input[type="checkbox"]').each(function(){
