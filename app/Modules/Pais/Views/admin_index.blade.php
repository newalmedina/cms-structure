        ...
        <div class="col-xs-12">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ trans('Pais::pais/admin_lang.listado') }}</h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="pull-right">
                        @if(Auth::user()->can("admin-pais-create"))
                            <a href="{{ url('admin/pais/create') }}" class="btn btn-success pull-right">
                                <i class="fa fa-plus-circle" aria-hidden="true"></i> {{ trans('Pais::pais/admin_lang.nueva') }}
                            </a>
                        @endif
                    </div>
                </div>
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="table_pais" class="table table-bordered table-striped" aria-hidden="true">
                        <thead>
                        <tr>
                            <th scope="col">
                            <th scope="col">
...
<th scope="col">
    ...
    <div class="col-xs-12">
        <div class="box ">
            <div class="box-header"><h3 class="box-title">{{ trans("Pais::pais/admin_lang.export") }}</h3></div>
            <div class="box-body">
                <a href="{{ url('admin/pais/export') }}" class="btn btn-app">
                    <i class="fa fa-file-excel-o" aria-hidden="true"></i>
                    {{ trans('Pais::pais/admin_lang.exportar_datos') }}
                </a>
            </div>
        </div>
    </div>
...
@section("foot_page")
        ...
        $(function () {
            oTable = $('#table_pais').DataTable({
                ...
                columns: [
                    ...
                    {
                        "title"         : "{!! trans('Pais::pais/admin_lang.fields.active') !!}",
                        orderable       : false,
                        searchable      : false,
                        data            : 'active',
                        sWidth          : '50px'
                        ...
                        {
                                "title"         : "{!! trans('Pais::pais/admin_lang.fields.name') !!}",
                                orderable       : true,
                                searchable      : true,
                                data            : 'name',
                                name            : 'c.name',
                        ...
                        ,
                        {
                                "title"         : "{!! trans('Pais::pais/admin_lang.fields.code') !!}",
                                orderable       : true,
                                searchable      : true,
                                data            : 'code',
                                name            : 'c.code',
                        ...
                        ,
                    {
                        "title"         : "{!! trans('Pais::pais/admin_lang.acciones') !!}",
                        orderable       : false,
                        searchable      : false,
                        sWidth          : '110px',
                        data            : 'actions'
            ...
            $('tfoot th',$('#table_pais')).each( function (colIdx) {
                var title = $('tfoot th',$('#table_pais')).eq( $(this).index() ).text();
            ...
            $('#table_pais').on( 'keyup change','tfoot input', function (e) {
                oTable
    ...
    $.ajax({
        ...
        $('#table_pais tbody').on('change', 'input[type="checkbox"]', function(){
        ...
        function deleteSelected() {
            ...
            if(ids.length>0){
                deleteElements('{{ url('admin/pais/delete-selected') }}', ids);
            }
        }

        function getSelectedRecords() {
            var ids = [];
            $('#table_pais input[type="checkbox"]').each(function(){
