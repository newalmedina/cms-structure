    ...
    <tr>
        <td bgcolor="#ffffff" width="100%">
            ...
            <table border="0" width="100%" cellpadding="0" cellspacing="0" aria-hidden="true">
                <tr>
                    <td style="background:none; border-bottom: 1px solid #D1B888; height:1px; width:100%; margin:0px 0px 0px 0px;">&nbsp;</td>
                </tr>
            </table>
            ...
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="table" aria-hidden="true">
                <tr>
                    <td width="600" class="cell">
                        <img border="0" src="{{ Request::getSchemeAndHttpHost() }}/assets/front/img/email/spacer.gif" width="1" height="15" class="divider"><br>
                                    ...
                                    <table width="600" cellpadding="0" cellspacing="0" border="0" class="table" aria-hidden="true">
                                        <tr>
                                            ...
                                            <td align="right" width="220" style="color:#a6a6a6;font-size:12px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;text-shadow: 0 1px 0 #ffffff;" valign="top" class="hide">
                                                ...
                                                <img border="0" src="{{ Request::getSchemeAndHttpHost() }}/assets/front/img/email/spacer.gif" width="1" height="10"><br><p style="color:#b3b3b3;font-size:11px;line-height:15px;font-family:Helvetica,Arial,sans-serif;margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0;font-weight:bold;">
                                                    {{ !empty($payload['senderName']) ? $payload['senderName'] : env("APP_NAME") }}
                                                </p>
