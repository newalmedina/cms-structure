        ...
        <div class="col-xs-12">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ trans("posts::admin_lang.tags_list") }}</h3>
                </div>

                <div class="box-body">
                    @if(Auth::user()->can("admin-posts-tags-create"))
                        <a href="{{ url('admin/posts/tags/create') }}" class="btn btn-success pull-right"><i class="fa fa-plus-circle" aria-hidden="true"></i> {{ trans('posts::admin_lang.nuevo_tag') }}</a>
                    @endif
                </div>
        ...
        $(function () {
            oTable = $('#table_tags').DataTable({
                ...
                ajax: {
                    ...
                    url         : "{{ url('admin/posts/tags/list') }}",
                    type        : "POST"
                },
                order: [[ 1, "asc" ]],
                columns: [
                    {
                        "title"         : "{!! trans('posts::admin_lang.activa') !!}",
                        orderable       : false,
                        searchable      : false,
                        data            : 'active',
                        sWidth          : '50px'
