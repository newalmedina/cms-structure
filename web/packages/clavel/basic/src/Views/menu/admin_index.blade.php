        ...
        <div class="col-xs-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ trans("basic::menu/admin_lang.listado_menu") }}</h3>
                </div>

                <div class="box-body">
                    @if(Auth::user()->can("admin-menu-create"))
                        <a href="{{ url('admin/menu/create') }}" class="btn btn-success pull-right"><i class="fa fa-plus-circle" aria-hidden="true"></i> {{ trans('basic::menu/admin_lang.nuevo_menu') }}</a>
                        @endif
                </div>
