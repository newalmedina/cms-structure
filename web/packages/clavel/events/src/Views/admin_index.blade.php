        ...
        <div class="col-xs-12">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ trans("Events::admin_lang.newpost") }}</h3>
                </div>

                <div class="box-body">
                    @if(Auth::user()->can("admin-events-create"))
                        <a href="{{ url('admin/events/create') }}" class="btn btn-success pull-right"><i class="fa fa-plus-circle" aria-hidden="true"></i> {{ trans('Events::admin_lang.nuevo_newpost') }}</a>
                    @endif
                </div>

                <!-- /.box-header -->
                <div class="box-body">
                    <table id="table_events" class="table table-bordered table-striped" aria-hidden="true">
                        <thead>
                        <tr>
                            <th scope="col"></th>
                            <th scope="col"></th>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            oTable = $('#table_events').DataTable({
                ...
                columns: [
                    {
                        "title"         : "{!! trans('Events::admin_lang.visible') !!}",
                        orderable       : false,
                        searchable      : false,
                        data            : 'active',
                        sWidth          : '50px'
                    ...
                    {
                        "title"         : "{!! trans('Events::admin_lang.titulo') !!}",
                        orderable       : true,
                        searchable      : true,
                        data            : 'title',name            : 'et.title',
                        sWidth          : ''
                    },
                    {
                        "title"         : "{!! trans('Events::admin_lang.url_seo') !!}",
                        orderable       : true,
                        searchable      : true,
                        data            : 'url_seo',name            : 'et.url_seo',
                        sWidth          : ''
                    },
                    {
                        "title"         : "{!! trans('Events::admin_lang.fechaNoticia') !!}",
                        orderable       : true,
                        searchable      : true,
                        data            : 'date_start',name            : 'e.date_start',
                        sWidth          : '70px'
                    },
                    {
                        "title"         : "{!! trans('Events::admin_lang.acciones') !!}",
                        orderable       : false,
                        searchable      : false,
                        sWidth          : '90px',
                        data            : 'actions'
            ...
            $('tfoot th',$('#table_events')).each( function (colIdx) {
                var title = $('tfoot th',$('#table_events')).eq( $(this).index() ).text();
            ...
            $('#table_events').on( 'keyup change','tfoot input', function (e) {
                oTable
            ...
            $.ajax({
                ...
                success : function(data) {
                    ...
                    if(data) {
                        ...
                        $("#alertModalHeader").html("Borrado de evento");
