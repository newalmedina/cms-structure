...
@section('breadcrumb')
    <li class="active">{{ trans('elearning::cursos/admin_lang.cursos') }}</li>
@stop
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box ">
                ...
                <div class="box-header"><h3 class="box-title">{{ trans("elearning::cursos/admin_lang.listado_cursos") }}</h3></div>

                <div class="box-body">
                    @if(Auth::user()->can("admin-cursos-create"))
                        <p>
                            <a href="{{ url('admin/cursos/create') }}" class="btn btn-primary">{{ trans('elearning::cursos/admin_lang.nuevo_pages') }}</a>
                        </p>
                    @endif

                    <table id="table_cursos" class="table table-bordered table-hover table-responsive"  style="width: 99.99%;" aria-hidden="true">
                        <thead>
                            <tr>
                                <th scope="col"></th>
                                <th scope="col"></th>
...
@section("foot_page")
    ...
    <script type="text/javascript">
        ...
        $(function () {
            oTable = $('#table_cursos').DataTable({
                ...
                ajax: {
                    ...
                    url         : "{{ url('admin/cursos/getData') }}",
                    type        : "POST"
                },
                order: [[ 1, "asc" ]],
                columns: [
                    {
                        "title"         : "{!! trans('elearning::cursos/admin_lang.activo') !!}",
                        orderable       : false,
                        searchable      : false,
                        data            : 'activo',
                        name            : 'activo',
                    ...
                    {
                        "title"         : "{!! trans('elearning::cursos/admin_lang.nombre') !!}",
                        orderable       : true,
                        searchable      : true,
                        data            : 'nombre',
                    ...
                    {
                        "title"         : "{!! trans('elearning::cursos/admin_lang.url_amigable') !!}",
                        orderable       : true,
                        searchable      : true,
                        data            : 'url_amigable',
                        name            : 'curso_translations.url_amigable',
                        sWidth          : ''
                    },
                    {
                        "title"         : "{!! trans('elearning::cursos/admin_lang.acciones') !!}",
                        orderable       : false,
                        searchable      : false,
                        sWidth          : '90px',
                        data            : 'actions'
        ...
        $('tfoot th',$('#table_cursos')).each( function (colIdx) {
            var title = $('tfoot th',$('#table_cursos')).eq( $(this).index() ).text();
        ...
        $('#table_cursos').on( 'keyup change','tfoot input', function (e) {
            oTable
