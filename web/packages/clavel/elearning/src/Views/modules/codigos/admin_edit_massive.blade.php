                        ...
                        <div class="col-md-5">
                            ...
                            <div class="box box-primary">
                                <div class="box-header  with-border">
                                    <h3 class="box-title">{{ trans("elearning::codigos/admin_lang.set_multi_code") }}</h3>
                                    <div class="box-tools pull-right">
                                        <span class="badge bg-gray" style="padding: 10px;">
                                            {{ trans("elearning::codigos/admin_lang.code_sample") }}: <span id="code_sample" style="font-weight: normal;"></span>
                                        </span>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <p style="padding-bottom: 20px;" class="text-warning">{{ trans("elearning::codigos/admin_lang.text_info_multi_code") }}</p>

                                    <div class="form-group">
                                        {!! Form::label('multi[prefix]', trans('elearning::codigos/admin_lang.prefijo'), array('class' => 'col-sm-2 control-label')) !!}
                                        <div class="col-sm-10">
                                            {!! Form::text('multi[prefix]', null, array('placeholder' => trans('elearning::codigos/admin_lang.prefijo'), 'class' => 'form-control', 'id'=>'prefijo')) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        {!! Form::label('multi[sufijo]', trans('elearning::codigos/admin_lang.sufijo'), array('class' => 'col-sm-2 control-label')) !!}
                                        <div class="col-sm-10">
                                            {!! Form::text('multi[sufijo]', null, array('placeholder' => trans('elearning::codigos/admin_lang.sufijo'), 'class' => 'form-control', 'id'=>'sufijo')) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        {!! Form::label('multi[n_inicio]', trans('elearning::codigos/admin_lang.n_inicio'), array('class' => 'col-sm-2 control-label')) !!}
                                        <div class="col-sm-10">
                                            {!! Form::text('multi[n_inicio]', null, array('placeholder' => trans('elearning::codigos/admin_lang.n_inicio'), 'class' => 'form-control', 'id'=>'n_inicio')) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        {!! Form::label('multi[n_final]', trans('elearning::codigos/admin_lang.n_final'), array('class' => 'col-sm-2 control-label')) !!}
                                        <div class="col-sm-10">
                                            {!! Form::text('multi[n_final]', null, array('placeholder' => trans('elearning::codigos/admin_lang.n_final'), 'class' => 'form-control', 'id'=>'n_final')) !!}
                                        </div>
                                    </div>
...
@section('foot_page')
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#prefijo, #sufijo, #n_inicio, #n_final").change(function() {
                if($("#prefijo").val()!='' && $("#sufijo").val()!='' && $("#n_inicio").val()!='' && $("#n_final").val()!='') {
                    $("#code_sample").html($("#prefijo").val() + $("#n_final").val() + $("#sufijo").val());
                } else {
                    $("#code_sample").html("");
                }
    ...
    {!! JsValidator::formRequest('Clavel\Elearning\Requests\CodigosMassiveRequest')->selector('#formData') !!}
@stop
