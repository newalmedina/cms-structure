...
class MatrixResponse implements ModelInterface, ArrayAccess
{
    ...
    'times' => 'float[][]',
    'weights' => 'double[][]',
    'info' => '\Clavel\Grafos\Services\GraphHopper\Models\ResponseInfo',
    'hints' => '\Clavel\Grafos\Services\GraphHopper\Models\MatrixResponseHints[]'    ];
     ...
     * Sets distances
     *
     * @param float[][] $distances The distance matrix for the specified points in the same order as the time matrix. The distances are in meters. If `fail_fast=false` the matrix will contain `null` for connections that could not be found.
     *
     * @return $this
     */
     ...
     * Sets times
     *
     * @param float[][] $times The time matrix for the specified points in the order [[from1->to1, from1->to2, ...], [from2->to1, from2->to2, ...], ...]. The times are in seconds. If `fail_fast=false` the matrix will contain `null` for connections that could not be found.
     *
     * @return $this
     */
     ...
     * Gets info
     *
     * @return \Clavel\Grafos\Services\GraphHopper\Models\ResponseInfo
     */
     ...
     * Sets info
     *
     * @param \Clavel\Grafos\Services\GraphHopper\Models\ResponseInfo $info info
     *
     * @return $this
     */
     ...
     * Gets hints
     *
     * @return \Clavel\Grafos\Services\GraphHopper\Models\MatrixResponseHints[]
     */
     ...
     * Sets hints
     *
     * @param \Clavel\Grafos\Services\GraphHopper\Models\MatrixResponseHints[] $hints Optional. Additional response data
     *
     * @return $this
     */
