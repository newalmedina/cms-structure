...
/**
 * InfoResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InfoResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets version
     *
     * @param string $version The version of the GraphHopper server that provided this response. This is not related to the API version.
     *
     * @return $this
     */
     ...
     * Sets bbox
     *
     * @param string $bbox The bounding box of the geographical area covered by this GraphHopper instance. Format: `\"minLon,minLat,maxLon,maxLat\"
     *
     * @return $this
     */
     ...
     * Sets features
     *
     * @param object $features The supported features, such as elevation, per vehicle profile.
     *
     * @return $this
     */
