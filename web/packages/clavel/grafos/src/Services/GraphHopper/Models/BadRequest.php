...
class BadRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'message' => 'string',
    'hints' => '\Clavel\Grafos\Services\GraphHopper\Models\ErrorMessage[]',
    'status' => 'string'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['status'] = isset($data['status']) ? $data['status'] : 'finished';
    }
     ...
     * Gets hints
     *
     * @return \Clavel\Grafos\Services\GraphHopper\Models\ErrorMessage[]
     */
     ...
     * Sets hints
     *
     * @param \Clavel\Grafos\Services\GraphHopper\Models\ErrorMessage[] $hints More detailed information about the error.
     *
     * @return $this
     */
