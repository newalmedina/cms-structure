...
class RouteResponsePath implements ModelInterface, ArrayAccess
{
    ...
    'ascend' => 'double',
    'descend' => 'double',
    'points' => '\Clavel\Grafos\Services\GraphHopper\Models\LineString',
    'snapped_waypoints' => '\Clavel\Grafos\Services\GraphHopper\Models\LineString',
    'points_encoded' => 'bool',
    'bbox' => 'double[]',
    'instructions' => '\Clavel\Grafos\Services\GraphHopper\Models\RouteResponsePathInstructions[]',
    'details' => 'object',
    'points_order' => 'int[]'    ];
     ...
     * Gets instructions
     *
     * @return \Clavel\Grafos\Services\GraphHopper\Models\RouteResponsePathInstructions[]
     */
     ...
     * Sets instructions
     *
     * @param \Clavel\Grafos\Services\GraphHopper\Models\RouteResponsePathInstructions[] $instructions The instructions for this route. This feature is under active development, and our instructions can sometimes be misleading, so be mindful when using them for navigation.
     *
     * @return $this
     */
