...
class TimeWindow implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['earliest'] = isset($data['earliest']) ? $data['earliest'] : 0;
     ...
     * Sets earliest
     *
     * @param int $earliest Specifies the opening time of the time window in seconds, i.e. the earliest time the service can start.
     *
     * @return $this
     */
     ...
     * Sets latest
     *
     * @param int $latest Specifies the closing time of the time window in seconds, i.e. the latest time the service can start.
     *
     * @return $this
     */
