...
class SolutionUnassigned implements ModelInterface, ArrayAccess
{
    ...
    'shipments' => 'string[]',
    'breaks' => 'string[]',
    'details' => '\Clavel\Grafos\Services\GraphHopper\Models\Detail[]'    ];
     ...
     * Gets details
     *
     * @return \Clavel\Grafos\Services\GraphHopper\Models\Detail[]
     */
     ...
     * Sets details
     *
     * @param \Clavel\Grafos\Services\GraphHopper\Models\Detail[] $details An array of details, i.e. reason for unassigned services or shipments
     *
     * @return $this
     */
