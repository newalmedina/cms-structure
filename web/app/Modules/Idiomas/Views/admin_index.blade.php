        ...
        <div class="col-xs-12">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ trans('Idiomas::idiomas/admin_lang.listado') }}</h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="pull-right">
                        @if(Auth::user()->can("admin-idiomas-create"))
                            <a href="{{ url('admin/idiomas/create') }}" class="btn btn-success pull-right">
                                <i class="fa fa-plus-circle" aria-hidden="true"></i> {{ trans('Idiomas::idiomas/admin_lang.nueva') }}
                            </a>
                        @endif
                    </div>
                </div>
