...
/**
 * RouteResponsePathInstructions Class Doc Comment
 *
 * @category Class
 * @package  Clavel\Grafos\Services\GraphHopper
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RouteResponsePathInstructions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RouteResponsePath_instructions';
     ...
     * Sets distance
     *
     * @param double $distance The distance for this instruction, in meters.
     *
     * @return $this
     */
     ...
     * Sets time
     *
     * @param int $time The duration for this instruction, in milliseconds.
     *
     * @return $this
     */
     ...
     * Sets interval
     *
     * @param int[] $interval Two indices into `points`, referring to the beginning and the end of the segment of the route this instruction refers to.
     *
     * @return $this
     */
     ...
     * Sets sign
     *
     * @param int $sign A number which specifies the sign to show:  |   |   | |---|---| |TURN_SHARP_LEFT |-3| |TURN_LEFT | -2| |TURN_SLIGHT_LEFT | -1| |CONTINUE_ON_STREET | 0| |TURN_SLIGHT_RIGHT |1| |TURN_RIGHT | 2| |TURN_SHARP_RIGHT | 3| |FINISH | 4| |VIA_REACHED | 5| |USE_ROUNDABOUT | 6| |KEEP_RIGHT | 7|
     *
     * @return $this
     */
     ...
     * Sets exit_number
     *
     * @param int $exit_number Only available for USE_ROUNDABOUT instructions. The count of exits at which the route leaves the roundabout.
     *
     * @return $this
     */
     ...
     * Sets turn_angle
     *
     * @param double $turn_angle Only available for USE_ROUNDABOUT instructions. The radian of the route within the roundabout `0 < r < 2*PI` for clockwise and `-2*PI < r < 0` for counterclockwise turns.
     *
     * @return $this
     */
