...
class Objective implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'min';
        $this->container['value'] = isset($data['value']) ? $data['value'] : 'transport_time';
    }
