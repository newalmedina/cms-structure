...
/**
 * InternalErrorMessage Class Doc Comment
 *
 * @category Class
 * @package  Clavel\Grafos\Services\GraphHopper
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InternalErrorMessage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InternalErrorMessage';
    ...
    {
        $this->container['code'] = isset($data['code']) ? $data['code'] : 500;
