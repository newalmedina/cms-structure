...
class ResponseInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResponseInfo';
     ...
     * Sets copyrights
     *
     * @param string[] $copyrights Attribution according to our documentation is necessary if no white-label option included.
     *
     * @return $this
     */
