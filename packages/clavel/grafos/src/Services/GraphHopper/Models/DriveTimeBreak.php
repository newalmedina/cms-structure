...
/**
 * DriveTimeBreak Class Doc Comment
 *
 * @category Class
 * @package  Clavel\Grafos\Services\GraphHopper
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DriveTimeBreak implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DriveTimeBreak';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['max_driving_time'] === null) {
            $invalidProperties[] = "'max_driving_time' can't be null";
        }
     ...
     * Sets duration
     *
     * @param int $duration Specifies the duration of the break in seconds.
     *
     * @return $this
     */
     ...
     *
     * @param int $max_driving_time Specifies the max driving time (in a row) without break in seconds.
     *
     * @return $this
     */
     ...
     *
     * @param int $initial_driving_time Specifies the initial (current) driving time of a driver to allow dynamic adaptations in seconds.
     *
     * @return $this
     */
     ...
     * Sets possible_split
     *
     * @param int[] $possible_split Array specifying how a break duration (in seconds) can be split into several smaller breaks
     *
     * @return $this
     */
