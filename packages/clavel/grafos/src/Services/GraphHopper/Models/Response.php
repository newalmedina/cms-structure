...
class Response implements ModelInterface, ArrayAccess
{
    ...
    'processing_time' => 'int',
    'solution' => '\Clavel\Grafos\Services\GraphHopper\Models\Solution'    ];
     ...
     * Sets job_id
     *
     * @param string $job_id UUID. Unique identifier of job - which you get when posting your request to the large problem solver
     *
     * @return $this
     */
     ...
     * Gets solution
     *
     * @return \Clavel\Grafos\Services\GraphHopper\Models\Solution
     */
     ...
     * Sets solution
     *
     * @param \Clavel\Grafos\Services\GraphHopper\Models\Solution $solution solution
     *
     * @return $this
     */
