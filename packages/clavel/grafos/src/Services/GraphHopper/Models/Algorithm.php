 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Algorithm implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getProblemTypeAllowableValues();
        if (!is_null($this->container['problem_type']) && !in_array($this->container['problem_type'], $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getProblemTypeAllowableValues();
        if (!is_null($problem_type) && !in_array($problem_type, $allowedValues, true)) {
