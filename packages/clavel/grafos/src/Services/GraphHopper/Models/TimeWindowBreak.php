...
/**
 * TimeWindowBreak Class Doc Comment
 *
 * @category Class
 * @package  Clavel\Grafos\Services\GraphHopper
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TimeWindowBreak implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TimeWindowBreak';
     ...
     * Sets earliest
     *
     * @param int $earliest Specifies the earliest start time of the break in seconds.
     *
     * @return $this
     */
     ...
     * Sets latest
     *
     * @param int $latest Specifies the latest start time of break in seconds.
     *
     * @return $this
     */
