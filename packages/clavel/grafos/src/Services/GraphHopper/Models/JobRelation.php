 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JobRelation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JobRelation';
     ...
     * Sets vehicle_id
     *
     * @param string $vehicle_id Id of pre-assigned vehicle, i.e. the vehicle id that is determined to conduct the services and shipments in this relation.
     *
     * @return $this
     */
