...
class GeocodingLocation implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'point' => '\Clavel\Grafos\Services\GraphHopper\Models\GeocodingPoint',
    'osm_id' => 'string',
    'osm_type' => 'string',
    'osm_key' => 'string',
    'name' => 'string',
     ...
     * Gets point
     *
     * @return \Clavel\Grafos\Services\GraphHopper\Models\GeocodingPoint
     */
     ...
     * Sets point
     *
     * @param \Clavel\Grafos\Services\GraphHopper\Models\GeocodingPoint $point point
     *
     * @return $this
     */
     ...
     * Sets osm_id
     *
     * @param string $osm_id The OSM ID of the entity
     *
     * @return $this
     */
     ...
     * Sets osm_key
     *
     * @param string $osm_key The OSM key of the entity
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of the entity. Can be a boundary, POI, address, etc
     *
     * @return $this
     */
     ...
     * Sets housenumber
     *
     * @param string $housenumber The housenumber of the address
     *
     * @return $this
     */
