...
/**
 * GroupRelation Class Doc Comment
 *
 * @category Class
 * @package  Clavel\Grafos\Services\GraphHopper
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupRelation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GroupRelation';
     ...
     * Sets type
     *
     * @param string $type Specifies the type of relation. It must be either of type `in_sequence` or `in_direct_sequence`.
     *
     * @return $this
     */
     ...
     * Sets groups
     *
     * @param string[] $groups An array of groups that should be related
     *
     * @return $this
     */
