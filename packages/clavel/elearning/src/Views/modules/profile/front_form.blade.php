...
@section('breadcrumb')
    <li><a href="{{ url("/profile") }}">{{ $page_title }}</a></li>
@stop

@section('carrousel')
    <img src="/assets/front/img/124A8814.jpg" alt="">
@stop

@section("head_page")

    <link href="{{ asset("assets/front/vendor/datepicker/datepicker3.css") }}" rel="stylesheet" type="text/css"/>
            ...
            <div class="col-md-2">
                <div class="thumbnail box-shadow-custom ">
                    <div id="fileOutput">
                        ...
                        @else
                            <p style="min-height: 150px; line-height: 150px;">
                                <i class="fa fa-camera" aria-hidden="true"></i> {{ trans("profile/front_lang.sin_foto") }}
                            </p>
                        @endif
                    </div>
                    <div class="caption" style=" text-align: center;">
                        <a id="remove" class="btn btn-danger btn-block" role="button" style="@if($user->userProfile->photo=='') display: none; @endif">{{ trans("profile/front_lang.quitar_foto") }}</a>
                    </div>
                </div>
            </div>
            <div class='col-md-10'>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6 form-group">
                                ...
                                {!! Form::text('userProfile[first_name]', $user->userProfile->first_name, array('placeholder' => trans('users/lang._INSERTAR_NOMBRE_USUARIO'), 'class' => 'form-control', 'id' => 'first_name')) !!}
                            </div>
                            <div class="col-lg-6 form-group">
                                {!! Form::label('userProfile[last_name]', trans('profile/front_lang._APELLIDOS_USUARIO')) !!} <span class="text-danger">*</span>
                                {!! Form::text('userProfile[last_name]', $user->userProfile->last_name, array('placeholder' => trans('users/lang._INSERTAR_APELLIDOS_USUARIO'), 'class' => 'form-control', 'id' => 'last_name')) !!}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 form-group">
                                ...
                                {!! Form::text('email', $user->email, array('placeholder' =>  Lang::get('profile/front_lang._INSERTAR_EMAIL_USUARIO'), 'class' => 'form-control')) !!}
                            </div>
                            <div class="col-lg-6 form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-6 form-group">
                                ...
                                {!! Form::text('username', $user->username, array('placeholder' => trans('profile/front_lang._INSERTAR_USUSARIO_USUARIO'), 'class' => 'form-control', 'required' => 'required')) !!}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 form-group">
                                ...
                                <div id="pswd_info">
                                    <h6>{{ trans('profile/front_lang._KEY_POSIBILITIES_INFO') }}</h6>
                                    <ul>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#remove").click(function() {
                $('#nombrefichero').val('');
                $('#profile_image').val("");
                $('#fileOutput').html('<p style="min-height: 150px; line-height: 150px;"><i class="fa fa-camera" aria-hidden="true"></i> {{ trans("profile/front_lang.sin_foto") }}</p>');
